...
USER jenkins
RUN echo 2.107.3 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state
RUN echo 2.107.3 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion
